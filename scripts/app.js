const app = new Vue({
    ...
    methods: {
        ...
        setColorOfModels: function(models) {
            this.minAcc = 1.0;
            this.maxAcc = 0.0;
            ...
            this.minAcc -= 0.0125;
            this.maxAcc += 0.0125;
            this.maxAcc = 1.0 < this.maxAcc ? 1.0 : this.maxAcc
        ...
        drawRankingLines: function(svg, rankingByClass, models, classNames) {
            ...
            _.forEach(modelNames, (modelName, yi) => {
                ...
                this.colors[modelName] = this.getColorOfModel(this.rankingColorScale, accuracy, this.minAcc, this.maxAcc)
